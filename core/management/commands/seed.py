...
class Command(BaseCommand):
    ...
    def seed_school(self):
        ...
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='KG1'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='KG1'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='KG2'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='KG2'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='Grade 1'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='Grade 1'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='Grade 2'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='Grade 2'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='Grade 3'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='Grade 3'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='Grade 4'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='Grade 4'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='Grade 5'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='Grade 5'))
        Section.objects.create(name='A', limit=5, grade=Grade.objects.get(name='Grade 6'))
        Section.objects.create(name='B', limit=5, grade=Grade.objects.get(name='Grade 6'))
