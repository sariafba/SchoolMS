    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('مشاجرة', 'مشاجرة'), ('تنمر', 'تنمر'), ('سوء تصرف', 'سوء تصرف'), ('تخريب اساس المدرسة', 'تخريب اساس المدرسة'), ('اخرى', 'اخرى')], max_length=20)),
                ('procedure', models.CharField(choices=[('تنبيه شفهي', 'تنبيه شفهي'), ('استدعاء ولي امر', 'استدعاء ولي امر'), ('كتابة تعهد', 'كتابة تعهد'), ('فصل نهائي', 'فصل نهائي')], max_length=20)),
                ('note', models.TextField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
